...
spa.timezone = +8.0
spa.delta_ut1 = 0   ## Fractional second difference between UTC and UT which is used
                    ## to adjust UTC for earth's irregular rotation rate and is derived
	                ## from observation only and is reported in this bulletin:
	                ## http:##maia.usno.navy.mil/ser7/ser7.dat,
	                ## where delta_ut1 = DUT1
	                ## valid range: -1 to 1 second (exclusive)
spa.delta_t = 67    ## Difference between earth rotation time and terrestrial time
...
spa.temperature = 11    ## Annual average local temperature [degrees Celsius], valid range: -273 to 6000 degrees Celsius
spa.slope = 30  ## Surface slope (measured from the horizontal plane), valid range: -360 to 360 degrees
